/*
 * WARNING: automatically generated by ort-c-source 0.8.3.
 * DO NOT EDIT!
 */
#include <sys/queue.h>
...
int
db_foo_update_bar_strset_bar_set(struct ort *ctx, const char *v1, const char *v2)
{
	enum sqlbox_code c;
	struct sqlbox *db = ctx->db;
	...
	crypt_newhash(v2, "blowfish,a", hash1, sizeof(hash1));
